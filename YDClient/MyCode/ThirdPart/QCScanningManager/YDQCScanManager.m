...
@interface YDQCScanManager ()<AVCaptureMetadataOutputObjectsDelegate>
...
@implementation YDQCScanManager

GPL_M_SINGLETON(YDQCScanManager);
...
- (void)setupSessionPreset:(NSString *)sessionPreset metadataObjectTypes:(NSArray *)metadataObjectTypes currentController:(UIViewController *)currentController {
    ...
    self.currentLayer = currentController.view.layer;
...
- (void)videoPreviewLayerAddToSuperlayer {
    [self.currentLayer insertSublayer:_videoPreviewLayer atIndex:0];
}
